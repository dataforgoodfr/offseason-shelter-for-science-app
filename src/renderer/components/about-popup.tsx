...
export default function AboutPopup({ onStopHosting, onContactUs, onGoToWebsite }: AboutPopupProps) {
    ...
    return (
        <div className="about-popup absolute top-12 right-0 z-50 w-48 bg-black text-white rounded-lg shadow-lg border border-gray-200 py-2"
            style={{ fontFamily: "Akzidenz-Grotesk Pro" }}
        >
            <div 
                className="flex items-center gap-3 px-4 py-2 hover:bg-gray-900 cursor-pointer transition-colors"
